...
export default function ShopGeneralForm({
    ...
    // Ensure that the values are arrays of numbers
    const categoriesAsNumbers = categories.map(Number);
    const tagsAsNumbers = tags.map(Number);
